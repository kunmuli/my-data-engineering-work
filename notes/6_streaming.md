...
In order to solve this, we can introduce a **_schema_** to the data so that producers can define the kind of data they're pushing and consumers can understand it.
